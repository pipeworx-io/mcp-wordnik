...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/definitions \
  -H 'Content-Type: application/json' \
  -d '{"word":"serendipity"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/definitions`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
